...
--
-- Host: localhost    Database: news-project
-- ------------------------------------------------------
...
INSERT INTO `banners` VALUES (8,'public/banner-image/2022-10-24-23-19-09.jpeg','http://localhost/OnlineNewsSite/','2022-10-24 14:19:09',NULL);
...
CREATE TABLE `categories` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(200) COLLATE utf8mb3_persian_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `categories` VALUES (14,'Technology','2022-10-24 09:26:37','2022-10-24 09:26:43'),(15,'Business','2022-10-24 09:36:05',NULL),(16,'Sports','2022-10-24 09:49:39',NULL),(17,'Science','2022-10-24 10:00:18',NULL);
...
INSERT INTO `comments` VALUES (2,2,'Interesting',15,'approved','2019-07-23 21:34:25','2020-08-11 01:48:30'),(16,2,'It doesn\'t look good',10,'approved','2020-04-09 20:23:52','2020-08-11 01:48:27'),(20,4,'It is exciting and stressful',22,'approved','2020-08-11 01:49:46','2020-10-04 23:55:00');
...
CREATE TABLE `menus` (
  ...
  `url` varchar(300) COLLATE utf8mb3_persian_ci NOT NULL,
...
INSERT INTO `menus` VALUES (9,'most visited','#',NULL,'2019-07-17 12:05:11','2022-10-24 11:33:11'),(12,'about us ','http://localhost/OnlineNewsSite/',NULL,'2022-10-24 14:38:39',NULL),(13,'Home','http://localhost/OnlineNewsSite/',NULL,'2022-10-24 14:39:03',NULL);
...
CREATE TABLE `posts` (
  ...
  `user_id` int NOT NULL,
  `cat_id` int NOT NULL,
  `image` varchar(200) COLLATE utf8mb3_persian_ci NOT NULL,
  `status` enum('disable','enable') COLLATE utf8mb3_persian_ci NOT NULL DEFAULT 'disable',
  `selected` tinyint NOT NULL DEFAULT '1',
  `breaking_news` tinyint NOT NULL DEFAULT '1',
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `permission` enum('user','admin') COLLATE utf8mb3_persian_ci NOT NULL DEFAULT 'user',
  `verify_token` varchar(191) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `is_active` tinyint NOT NULL DEFAULT '0',
  `forgot_token` varchar(191) COLLATE utf8mb3_persian_ci DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'admin','onlinenewssite@admin.com','$2y$10$IN3YIlgIvxiHxdBvNVz/GOm72x2h5aBvV9J2QmsVhLLwkvooKBhbm','admin','cf408fb6caedd3c8308a21254b1a3cb4a5c8757f7740354104af7b43dfe7bff6',1,NULL,NULL,'2023-06-12 16:17:46','2023-06-12 16:31:15'),(2,'louis','louis@yahoo.com','$2y$10$kUh4xMjKTXeNiy7jSIJO6.LOVBth9hQiPwMi0BgD.ao2uWBDn1OB.','user',NULL,1,NULL,NULL,'2021-06-23 23:35:51','2019-07-05 02:10:50'),(3,'kam','kamran@gmail.com','$2y$10$nlZ5dMJ2sv9HrKU4NJslDe0ick10lGSBZNM2i14zKtDGGAEqAdXVS','user',NULL,0,NULL,NULL,'2019-06-06 01:28:40','2023-06-12 16:13:53'),(4,'nova','nova@yahoo.com','$2y$10$CrqnkHtp2dKlyHfYRniXG.B8fWtrHtfavUyGVqc6bdiiF5lgwzi96','user',NULL,1,NULL,NULL,'2019-10-27 21:56:13','2019-10-27 22:18:23');
...
CREATE TABLE `websetting` (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` text COLLATE utf8mb3_persian_ci,
  `description` text COLLATE utf8mb3_persian_ci,
  `keywords` text COLLATE utf8mb3_persian_ci,
  `logo` text COLLATE utf8mb3_persian_ci,
  `icon` text COLLATE utf8mb3_persian_ci,
  `created_at` datetime NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `websetting` VALUES (1,'online news','online news','online news','public/setting/logo.png','public/setting/icon.jpeg','2019-06-09 19:54:37','2022-10-24 16:41:31');
/*!40000 ALTER TABLE `websetting` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'news-project'
--
...
-- Dump completed on 2026-01-18 19:54:28
